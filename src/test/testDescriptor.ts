...
export function BGField(dynamic: boolean = false) {
...
role.timeMap.set(1, new TestInner(1, 3));
role.timeMap.set(2, new TestInner(2, 4));
...
console.log(role.timeMap.get(1).uid);
console.log(role.dirtyFields());
role.clearDirty();
console.log(role.dirtyFields());

role.timeMap.get(1).array.push(new TestInnest(1, 0));
role.timeMap.get(1).array.push(new TestInnest(2, 0));
console.log(role.dirtyFields());
role.clearDirty();
console.log(role.dirtyFields());

role.timeMap.get(1).array.get(0).test = 1;
console.log(role.dirtyFields());
role.clearDirty();
console.log(role.dirtyFields());

role.timeMap.get(1).array.insert(1, new TestInnest(1.5, 0));
role.timeMap.get(1).array.insert(1, new TestInnest(1.6, 0));
console.log(role.dirtyFields());
role.clearDirty();
console.log(role.dirtyFields());

role.timeMap.get(1).array.remove(1);
console.log(role.timeMap.get(1).array.length);
console.log(role.dirtyFields());
role.clearDirty();
console.log(role.dirtyFields());
